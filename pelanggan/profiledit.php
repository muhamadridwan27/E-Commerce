...
<input name="idpelanggan" type="hidden" id="idpelanggan" value="<?php echo"$rm[idpelanggan]";?>" />
  <p><strong>USERNAME</strong><br> 
    <label>
    <input name="usernamepel" type="text" id="usernamepel" value="<?php echo"$rm[usernamepel]";?>" readonly/>
    </label>
  </p>
...
<div class="dh6">
  ...
  <p>
   <?php
     if($rm["jk"] == "Laki Laki"){  $l = " checked"; }
  else if($rm["jk"] == "Perempuan"){ $p = " checked"; }
  ?>
...
if(isset($_POST["simpan"])){
  include "koneksi.php";
	...
	echo "<META HTTP-EQUIV='Refresh' Content='0.5; URL=?p=profile'>";
}
?>
</fieldset>
</div>