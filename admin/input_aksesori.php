...
<div id="forum">
  <div class="grid">
    ...
    <a href="<?php echo "?p=aksesoris";?>">Daftar Aksesori</a> &raquo;
  <span class="style1">Input Aksesori</span>  </div>
</div>

<div id="frmreg">
<fieldset>
<h3>Input Aksesori</h3>
...
<div class="dh6">
  <p><strong>Nama Aksesori</strong><br />
    <label>
...
if($_POST["simpan"]){
  ...
  if(!empty($lokfoto)){
	...
	if($sqlm){
	  ...
	  echo "<META HTTP-EQUIV='Refresh' Content='1.5; URL=?p=aksesoris'>";
	}else{
...
<fieldset>
<body>
<marquee>SSelamat Datang Pada Website <span class="style1">Venny Pelaminan</span>
</marquee>
</body>
</fieldset>
</div>
